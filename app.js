...
function brandSupHtml(value) {
  ...
  return String(value).replace(/®/g, '<sup class="reg-mark">®</sup>');
      ...
      <div class="card ${isOpen ? "open" : ""}" data-id="${p.id}">
        ...
        <div class="card-summary">
          ...
          <div class="product-thumb" aria-hidden="true">
            ...
            <img src="${p.id}.png" alt="" loading="lazy"

              onerror="this.style.display='none'; this.parentElement.classList.add('empty-thumb');" />
